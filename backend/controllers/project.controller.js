...
export const deleteProject = async (req, res) => {
  ...
  try {
    ...
    if (!deletedProject) {
      return res
        .status(404)
        .json({ error: "Project not found or user not authorized" });
    }
...
export const getAllProjectsOfUserByUserId = async (req, res) => {
  try {
    ...
    const projects = await projectService.getAllProjectsOfUserByUserId({
      userId,
    });
...
export const getAllUsersOfProjectById = async (req, res) => {
  ...
  try {
    ...
    const users = await projectService.getAllUsersOfProjectById({ projectId });
